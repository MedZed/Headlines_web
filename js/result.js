...
//other apiKey 7b4ca702fb474bd7b05d4f8e3666a8e1   


function getTheData(links, category){
  for(var url in links){

  $.getJSON('https://newsapi.org/v1/articles?source='+links[url]+'&apiKey=5440103977e240da98b3f4c0f775813a', function(yt_data) {
